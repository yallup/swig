...
def build_kernel(
    ...
    def constrained_mcmc_fn(
        ...
        def psi_slice_step(rng_key, current_psi, current_theta, current_ll_cache):
            ...
            final_ss, slice_info = _run_slice(rng_key, init_ss, slice_fn)
    ...
    inner_kernel = update_with_mcmc_take_last(constrained_mcmc_fn, num_mcmc_steps=num_gibbs_sweeps, num_delete=num_delete)
